...
window = CreateWindow(
    background_color=config.get_config_json("COLORS", "BLACK"),
    window_title=config.get_config_json("WINDOW", "TITLE"),
    width=config.get_config_json("WINDOW", "WIDTH"),
    high=config.get_config_json("WINDOW", "HIGH"),
...
Close(
    parent=window,
    background_color=config.get_config_json("COLORS", "BLACK"),
    color_exit_button_mouse_in=config.get_config_json("COLORS", "RED"),
    color_button_exit_mouse_out=config.get_config_json("COLORS", "DARK_RED"),
    color_button_minimize_mouse_in=config.get_config_json("COLORS", "ORANGE"),
    color_button_minimize_mouse_out=config.get_config_json("COLORS", "DARK_ORANGE"),
    color_button_cancel_mouse_in=config.get_config_json("COLORS", "YELLOW"),
    color_button_cancel_mouse_out=config.get_config_json("COLORS", "DARK_YELLOW"),
    width=config.get_config_json("WINDOW_CONTROL_CLOSE", "WIDTH"),
    high=config.get_config_json("WINDOW_CONTROL_CLOSE", "HIGH"),
    color_label=config.get_config_json("COLORS", "BLUE_LABELS"),
)
...
class Main:
    ...
    def __init__(self):
        ...
        self.button_select_location = CreateButton(
            ...
            font_size=16,
            window=window,
            color_mouse_in=config.get_config_json("COLORS", "GREEN"),
            color_mouse_out=config.get_config_json("COLORS", "DARK_GREEN"),
        ...
        self.button_download_video = CreateButton(
            ...
            y_axis_position=322,
            width=15,
            background_color=config.get_config_json("COLORS", "DARK_YELLOW"),
            function=lambda: [
            ...
            font_size=15,
            window=window,
            color_mouse_in=config.get_config_json("COLORS", "YELLOW"),
            color_mouse_out=config.get_config_json("COLORS", "DARK_YELLOW"),
