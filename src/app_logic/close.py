...
class DialogClose:
    ...
    def __init__(
        ...
        self.top = Toplevel()
        self.top.title(config.get_config_execel(excel_column_number=10))
        ...
        self.label_confirmation_closing = CreateLabel(
            text=config.get_config_execel(excel_column_number=6),
            y_axis_position=10,
            width=26,
        ...
        self.exit_button = CreateButton(
            text=config.get_config_execel(excel_column_number=7),
            x_axis_position=15,
            y_axis_position=50,
            width=15,
        ...
        self.button_minimize = CreateButton(
            text=config.get_config_execel(excel_column_number=8),
            x_axis_position=173,
            y_axis_position=50,
            width=15,
        ...
        self.button_cancel = CreateButton(
            text=config.get_config_execel(excel_column_number=9),
            x_axis_position=40,
            y_axis_position=90,
            width=25,
